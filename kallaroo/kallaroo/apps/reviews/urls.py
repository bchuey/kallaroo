...
urlpatterns = [
	...
	url(r'^task/(?P<task_id>\d+)/add-review/$', views.AddTaskReview.as_view(), name='add-task-review'),
	url(r'^task/(?P<task_id>\d+)/add-rating/$', views.AddTaskRating.as_view(), name='add-task-rating'),
