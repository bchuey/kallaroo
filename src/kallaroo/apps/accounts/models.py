...
class User(AbstractBaseUser):
	...
	stripe_account_id = models.CharField(max_length=255, null=True, blank=True, editable=False)
	stripe_customer_id = models.CharField(max_length=255, null=True, blank=True, editable=False)
	stripe_card_id = models.CharField(max_length=255, null=True, blank=True, editable=False)
	stripe_bank_account_id = models.CharField(max_length=255, null=True, blank=True, editable=False)

	stripe_secret_key = models.CharField(max_length=255, null=True, blank=True, editable=False)
	stripe_publishable_key = models.CharField(max_length=255, null=True, blank=True, editable=False)
